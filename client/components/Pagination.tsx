...
export default function Pagination({page, meta, toPreviousPage, toNextPage} : PaginationProp) {
    return (
         <div className="max-w-7xl mx-auto mt-12 px-4 text-gray-600 md:px-8">
            <div className="flex gap-4 items-center justify-between text-sm text-gray-600 font-medium">
                ...
                <button onClick={() => toNextPage()} disabled={page + 1 > meta.totalPages} className="px-4 py-2 border rounded-lg duration-150 hover:bg-gray-50">
                    Next
                </button>
            </div>
        </div>
